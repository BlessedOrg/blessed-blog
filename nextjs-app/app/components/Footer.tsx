          ...
          <div className="flex flex-col sm:flex-row items-start gap-8 sm:gap-16 lg:gap-64 w-full">
            ...
            <div className="flex flex-col sm:flex-row gap-8 sm:gap-16 lg:gap-40">
              <div className="flex flex-col gap-4">
                ...
                <span>
                  <Link href="https://blessed.fan/use-cases">Use cases</Link>
                </span>
                {/* <span>
                ...
                <span>
                  <Link href="https://blessed.fan/pricing">Pricing</Link>
                </span>
              </div>
              ...
              <div className="flex flex-col gap-4">
                ...
                <span>
                  <Link href="https://blessed.fan/about-us">About us</Link>
                </span>
                <span>
                  <Link href="https://blessed.fan/contact-us">Contact</Link>
                </span>
                <span>
                  <Link href="https://blessed.fan/terms-and-conditions">
                    Terms & conditions
                  </Link>
                </span>
                <span>
                  <Link href="https://blessed.fan/privacy-policy">
                    Privacy policy
                  </Link>
                </span>
              </div>
